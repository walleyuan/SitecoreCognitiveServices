...
namespace Microsoft.SharedSource.CognitiveServices.Repositories.Language {
    public class LuisRepository : ILuisRepository
    {
        ...
        public virtual QueryResult Query(Guid appId, string query) {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisQueryUrl}{appId}?subscription-key={ApiKeys.Luis}&verbose=true&q={query}");
        ...
        public virtual void DeleteApplication(Guid appId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}");
        }
        ...
        public virtual List<List<string>> DownloadApplicationQueryLogs(Guid appId) {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/querylogs");
        ...
        public virtual List<ApplicationCulture> GetApplicationCultures() {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}cultures");
        ...
        public virtual List<string> GetApplicationDomains() {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}domains");
        ...
        public virtual ApplicationInfo GetApplicationInfo(Guid appId) {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}");
        ...
        public virtual List<string> GetApplicationUsageScenarios() {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}usagescenarios");
        ...
        public virtual PersonalAssistantResponse GetPersonalAssistantApplications() {
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}assistants");
        ...
        public virtual List<UserApplication> GetUserApplications(int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual string ImportApplication(ApplicationDefinition request, string appName = "")
        {
            ...
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}import{appQS}", JsonConvert.SerializeObject(request));
        ...
        public virtual PublishResponse PublishApplication(Guid appId, PublishRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/publish", JsonConvert.SerializeObject(request));
        ...
        public virtual void RenameApplication(Guid appId, ApplicationRenameRequest request) {
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual AddLabelResponse AddLabel(Guid appId, string versionId, AddLabelRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/example", JsonConvert.SerializeObject(request));
        ...
        public virtual List<BatchAddLabelsResponse> BatchAddLabels(Guid appId, string versionId, List<AddLabelRequest> request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/examples", JsonConvert.SerializeObject(request));
        ...
        public virtual void DeleteExampleLabel(Guid appId, string versionId, int exampleId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/examples/{exampleId}");
        }
        ...
        public virtual List<LabeledExamples> ReviewLabeledExamples(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/examples{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual int CreatePatternFeature(Guid appId, string versionId, PatternFeature feature) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/patterns", JsonConvert.SerializeObject(feature));
        ...
        public virtual int CreatePhraseListFeature(Guid appId, string versionId, PhraseListFeature feature) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/phraselists", JsonConvert.SerializeObject(feature));
        ...
        public virtual void DeletePatternFeature(Guid appId, string versionId, int patternId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/patterns/{patternId}");
        }
        ...
        public virtual void DeletePhraseListFeature(Guid appId, string versionId, int phraselistId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/phraselists/{phraselistId}");
        }
        ...
        public virtual ApplicationFeaturesResponse GetApplicationVersionFeatures(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/feature{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<PatternFeature> GetApplicationVersionPatternFeatures(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/patterns{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<PhraseListFeature> GetApplicationVersionPhraseListFeatures(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/phraselists{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual PatternFeature GetPatternFeatureInfo(Guid appId, string versionId, int patternId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/patterns/{patternId}");
        ...
        public virtual PhraseListFeature GetPhraseListFeatureInfo(Guid appId, string versionId, int phraselistId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/phraselists/{phraselistId}");
        ...
        public virtual void UpdatePatternFeature(Guid appId, string versionId, int patternId, PatternFeature feature) {
            ...
            var response = RepositoryClient.SendJsonUpdate(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/patterns/{patternId}", JsonConvert.SerializeObject(feature));
        }
        ...
        public virtual void UpdatePhraseListFeature(Guid appId, string versionId, int phraselistId, PhraseListFeature feature) {
            ...
            var response = RepositoryClient.SendJsonUpdate(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/phraselists/{phraselistId}", JsonConvert.SerializeObject(feature));
        }
        ...
        public virtual List<EntityInfo> AddPrebuiltEntityExtractors(Guid appId, string versionId, List<string> extractorNames) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/prebuilts", JsonConvert.SerializeObject(extractorNames));
        ...
        public virtual Guid CreateClosedListEntityModel(Guid appId, string versionId, ClosedListEntityRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists", JsonConvert.SerializeObject(request));
        ...
        public virtual Guid CreateCompositeEntityExtractor(Guid appId, string versionId, ComplexEntityRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/compositeentities", JsonConvert.SerializeObject(request));
        ...
        public virtual Guid CreateEntityExtractor(Guid appId, string versionId, NamedEntityRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities", JsonConvert.SerializeObject(request));
        ...
        public virtual Guid CreateHeirarchicalEntityExtractor(Guid appId, string versionId, ComplexEntityRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/hierarchicalentities", JsonConvert.SerializeObject(request));
        ...
        public virtual Guid CreateIntentClassifier(Guid appId, string versionId, NamedEntityRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents", JsonConvert.SerializeObject(request));
        ...
        public virtual void DeleteClosedListEntityModel(Guid appId, string versionId, Guid closedListEntityId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists/{closedListEntityId}");
        }
        ...
        public virtual void DeleteCompositeEntityModel(Guid appId, string versionId, Guid compositeEntityId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/compositeentities/{compositeEntityId}");
        }
        ...
        public virtual void DeleteEntityModel(Guid appId, string versionId, Guid entityId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities/{entityId}");
        }
        ...
        public virtual void DeleteHierarchicalEntityModel(Guid appId, string versionId, Guid heirarchicalEntityId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/hierarchicalentities/{heirarchicalEntityId}");
        }
        ...
        public virtual void DeleteIntentModel(Guid appId, string versionId, Guid intentId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents/{intentId}");
        }
        ...
        public virtual void DeletePrebuiltModel(Guid appId, string versionId, Guid prebuiltId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/prebuilts/{prebuiltId}");
        }
        ...
        public virtual void DeletePrebuiltModel(Guid appId, string versionId, Guid closedListEntityId, int sublistId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists/{closedListEntityId}/sublists/{sublistId}");
        }
        ...
        public virtual ClosedListEntityInfo GetApplicationVersionClosedListInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual ComplexEntityInfo GetApplicationVersionCompositeEntityInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/compositeentities{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<EntityInfo> GetApplicationVersionEntityInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<ComplexEntityInfo> GetApplicationVersionHeirarchicalEntityInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/hierarchicalentities{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<EntityInfo> GetApplicationVersionIntentInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<EntityInfo> GetApplicationVersionModelInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/models{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<EntityInfo> GetApplicationVersionPrebuiltInfos(Guid appId, string versionId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/prebuilts{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual List<PrebuiltEntity> GetAvailablePrebuiltEntityExtractors(Guid appId, string versionId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/listprebuilts");
        ...
        public virtual ClosedListEntityInfo GetClosedListEntityInfo(Guid appId, string versionId, Guid closedListEntityId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists/{closedListEntityId}");
        ...
        public virtual ComplexEntityInfo GetCompositeEntityInfo(Guid appId, string versionId, Guid compositeEntityId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/compositeentities/{compositeEntityId}");
        ...
        public virtual EntityInfo GetEntityInfo(Guid appId, string versionId, Guid entityId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities/{entityId}");
        ...
        public virtual ComplexEntityInfo GetHeirarchicalEntityInfo(Guid appId, string versionId, Guid heirarchicalEntityId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/hierarchicalentities/{heirarchicalEntityId}");
        ...
        public virtual EntityInfo GetIntentInfo(Guid appId, string versionId, Guid intentId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents/{intentId}");
        ...
        public virtual EntityInfo GetPrebuiltInfo(Guid appId, string versionId, Guid prebuiltId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/prebuilts/{prebuiltId}");
        ...
        public virtual void PatchClosedListEntityModel(Guid appId, string versionId, Guid closedListEntityId, PatchClosedListEntityModelRequest request) {
            ...
            var response = RepositoryClient.SendJsonPatch(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists/{closedListEntityId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void RenameEntityModel(Guid appId, string versionId, Guid entityId, NamedEntityRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities/{entityId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void RenameIntentModel(Guid appId, string versionId, Guid intentId, NamedEntityRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents/{intentId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual List<LabeledExamples> SuggestEndpointQueriesForEntities(Guid appId, string versionId, Guid entityId, int take = 10) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities/{entityId}/suggest{qs}");
        ...
        {
            var qs = GetTakeQuerystring(take);
            var response = await RepositoryClient.SendGetAsync(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/entities/{entityId}/suggest{qs}");
        ...
        public virtual List<LabeledExamples> SuggestEndpointQueriesForIntents(Guid appId, string versionId, Guid intentId, int take = 10) {
            var qs = GetTakeQuerystring(take);
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents/{intentId}/suggest{qs}");
        ...
        public virtual async Task<List<LabeledExamples>> SuggestEndpointQueriesForIntentsAsync(Guid appId, string versionId, Guid intentId, int take = 10) {
            var qs = GetTakeQuerystring(take);
            var response = await RepositoryClient.SendGetAsync(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/intents/{intentId}/suggest{qs}");
        ...
        public virtual void UpdateClosedListEntityModel(Guid appId, string versionId, Guid closedListEntityId, ClosedListEntityRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/closedlists/{closedListEntityId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void UpdateCompositeEntityModel(Guid appId, string versionId, Guid compositeEntityId, ComplexEntityRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/compositeentities/{compositeEntityId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void UpdateHeirarchicalEntityModel(Guid appId, string versionId, Guid heirarchicalEntityId, ComplexEntityRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/hierarchicalentities/{heirarchicalEntityId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual List<ModelTrainingStatus> GetApplicationVersionTrainingStatus(Guid appId, string versionId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/train");
        ...
        public virtual void TrainApplicationVersion(Guid appId, string versionId) {
            ...
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/train");
        }
        ...
        public virtual void AddExternalApiKey(ExternalApiKeyRequest request) {
            ...
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, luisApiKeyUrl, JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void AddSubscriptionKey(SubscriptionKeySet request) {
            ...
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, luisSubKeyUrl, JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void DeleteExternalApiKey(string externalApiKey) {
            ...
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisApiKeyUrl}{externalApiKey}");
        }
        ...
        public virtual void DeleteSubscriptionKey(string subscriptionKey) {
            ...
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisSubKeyUrl}{subscriptionKey}");
        }
        ...
        public virtual ExternalApiKeySet GetExternalApiKey() {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, luisApiKeyUrl);
        ...
        public virtual string ResetProgrammaticKey() {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, luisProgKeyUrl, "");
        ...
        public virtual void AssignSubscriptionKeyToVersion(Guid appId, string versionId, string subscriptionKey) {
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/assignedkey", subscriptionKey);
        }
        ...
        public virtual string CloneVersion(Guid appId, string versionId, VersionRequest request) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/clone", JsonConvert.SerializeObject(request));
        ...
        public virtual void DeleteApplicationVersion(Guid appId, string versionId) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}");
        }
        ...
        public virtual void DeleteApplicationVersionExternalKey(Guid appId, string versionId, string keyType) {
            var response = RepositoryClient.SendJsonDelete(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/externalKeys/{keyType}");
        }
        ...
        public virtual ApplicationDefinition ExportApplicationVersion(Guid appId, string versionId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/export");
        ...
        public virtual ApplicationVersion GetApplicationVersion(Guid appId, string versionId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}");
        ...
        public virtual SubscriptionKeySet GetApplicationVersionSubscriptionKeys(Guid appId, string versionId) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/assignedkey");
        ...
        public virtual List<ApplicationVersion> GetApplicationVersions(Guid appId, int skip = 0, int take = 100) {
            ...
            var response = RepositoryClient.SendGet(ApiKeys.Luis, $"{luisUrl}{appId}/versions{GetSkipTakeQuerystring(skip, take)}");
        ...
        public virtual string ImportVersionToApplication(Guid appId, ApplicationDefinition definition, string versionId = "") {
            ...
            var response = RepositoryClient.SendJsonPost(ApiKeys.Luis, $"{luisUrl}{appId}/versions/import{qs}", JsonConvert.SerializeObject(definition));
        ...
        public virtual async Task<string> ImportVersionToApplicationAsync(Guid appId, ApplicationDefinition definition, string versionId = "")
        {
            ...
            var qs = GetAppVersionQuerystring(versionId);
            var response = await RepositoryClient.SendJsonPostAsync(ApiKeys.Luis, $"{luisUrl}{appId}/versions/import{qs}", JsonConvert.SerializeObject(definition));
        ...
        public virtual void RenameApplicationVersion(Guid appId, string versionId, VersionRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}", JsonConvert.SerializeObject(request));
        }
        ...
        public virtual void UpdateApplicationVersionExternalKey(Guid appId, string versionId, ExternalApiKeyRequest request) {
            ...
            var response = RepositoryClient.SendJsonPut(ApiKeys.Luis, $"{luisUrl}{appId}/versions/{versionId}/externalKeys", JsonConvert.SerializeObject(request));
        }
